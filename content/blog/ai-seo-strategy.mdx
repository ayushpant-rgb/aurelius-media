...
ogImage: "/blog/ai-seo-strategy.jpg"
keywords:
  - AI SEO strategy
...
But a more important finding emerged from a Semrush study analyzing **230,000 prompts and over 100 million AI citations** across ChatGPT, Google AI Mode, and Perplexity: Reddit's citation share on ChatGPT collapsed from ~60% of responses in August 2025 to ~10% by mid-September, after a single platform change. Wikipedia followed a similar trajectory, dropping from ~55% to under 20% in ChatGPT.

The winners after that shift? PRNewsWire, Forbes, and Medium — not because of some strategic insight, but because ChatGPT actively diversified away from over-relying on any single source.

![ChatGPT Reddit Citation Rate 2025: dropped from 60% in August to 10% in September after algorithm change](/blog/ai-seo-reddit-citations.jpg)

The lesson isn't "don't target Reddit." It's that platform-specific citation behavior is volatile and unpredictable. A strategy built around getting onto Reddit because it's heavily cited today can be made irrelevant by a single model update tomorrow.

For product-specific queries — where brand citations actually matter — LLMs cite industry-specific review sites, comparison pages, and category-specific publications 86% of the time, and generic sites like Reddit only 16% of the time. That ratio holds even as overall Reddit citation frequency fluctuates.
...
<div className="blog-stats">
  ...
  <div className="blog-stat">
    ...
    <div className="blog-stat-label">Reddit's ChatGPT citation rate after September 2025 — down from 60% in August</div>
  </div>
</div>
...
If you're working on [AI marketing strategy](/services/ai-marketing-automation) or want a structured approach to content and search visibility that's built for both Google and the LLMs that depend on it, the fundamentals haven't changed — but the stakes for getting them right have.
