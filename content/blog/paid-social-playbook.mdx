...
faqs:
  - question: "How much budget do I need to start paid social?"
    answer: "The minimum viable budget is roughly 50× your target CPA per ad set per week — that's the threshold to exit Meta's Learning Phase and get statistically reliable data. If your target CPA is $30, you need ~$1,500/week ($6,000/month) per ad set to get clean data. Below that, you're optimizing based on noise."
  - question: "How long does it take to see results from paid social?"
    answer: "Budget at least 4–6 weeks before drawing conclusions. The first 2 weeks are Learning Phase — spend is less efficient while the algorithm calibrates. Weeks 3–4 you'll start to see real signal. By week 6, you should have enough data to identify your top 2–3 creative winners and optimize campaign structure around them."
  - question: "Meta vs TikTok: where should I start?"
  ...
  - question: "What's a good ROAS benchmark for Meta Ads?"
    answer: "It depends on your vertical and margin structure. Sales-optimized campaigns average 4.87x ROAS platform-wide. Retargeting campaigns average 3.61x, prospecting averages 2.11x. The more useful question is: what ROAS do you need to be profitable given your contribution margins? That number — not a platform average — is your real target."
  - question: "How many creatives should I be testing at once?"
    answer: "At budgets under $10K/month: 5–8 active creative variations. At $10K–$50K/month: 10–15 variations. Above $50K/month: 20+ variations with a continuous production pipeline. The upper bound is determined by your production capacity and your ability to track performance per asset — not by the platform's limits."
  - question: "Why does my ROAS look great in Meta but revenue isn't growing?"
    answer: "Attribution inflation. Meta over-reports conversions due to view-through attribution and cross-device measurement gaps. A user might see your ad, then search your brand on Google, then convert — Meta claims the credit and so does Google. Track MER (total revenue ÷ total spend) as your ground-truth metric alongside platform ROAS, and run a 48-hour blackout test to verify incrementality."
---
...
*This playbook covers Meta and TikTok in depth. For the complete multi-channel picture — Google, YouTube, LinkedIn, India benchmarks, and a full budget framework — read [The Complete Performance Marketing Guide for Indian Brands 2026](/blog/performance-marketing-guide).*
...
**5. Over-reliance on paid at the expense of organic.** [Paid social is not a substitute for organic pull](/blog/what-works-on-instagram-2026). It's an accelerant for it. Brands that invest nothing in [organic social media marketing](/services/social-media-marketing), community, and email are building on a foundation that collapses every time their ad account gets restricted or CPMs spike. Use paid to amplify — not replace — what's already working organically.
...
**Ready to audit your paid social setup?** Aurelius Media is a [Meta Ads agency in India](/services/meta-ads-management) working with D2C, edtech, and consumer brands on exactly this — building the creative engine and campaign architecture that compounds. [Book a free 15-minute strategy call](https://cal.com/aureliusmedia/15min) and we'll walk through your account, identify the structural gaps, and map out what a real creative testing system looks like for your business.
