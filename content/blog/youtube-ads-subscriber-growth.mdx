...
**Typical CPV:** $0.02–$0.05. You only pay when someone watches 30 seconds or the full video (whichever comes first) or clicks. This makes TrueView one of the most efficient formats for awareness and subscriber acquisition.
...
**Key setup considerations:** Target audiences who already consume content in your category. Let the algorithm optimize for subscription events, not just views. Budget for at least 90 days before evaluating — these campaigns need time to find their audience.
...
<div className="blog-stats">
  <div className="blog-stat">
    <div className="blog-stat-num">$0.02–$0.05</div>
    <div className="blog-stat-label">Typical cost per view (CPV) for TrueView in-stream</div>
  </div>
  <div className="blog-stat">
  ...
  <div className="blog-stat">
    <div className="blog-stat-num">90+ days</div>
    <div className="blog-stat-label">Minimum evaluation window before drawing conclusions</div>
  </div>
</div>
...
**Phase 2 (Days 31–60):** Consolidate budget into the top two performing targeting segments and creative variants. Cut anything with CPV above $0.08 or subscriber conversion rate below 1%.
