...
const serviceBlogCategoryMap: Record<string, string[]> = {
    ...
    'real-estate-marketing': ['Real Estate Marketing', 'Performance Marketing'],
    'real-estate-marketing-dubai': ['Real Estate Marketing', 'Performance Marketing'],
    'performance-marketing': ['Performance Marketing', 'Google Ads'],
