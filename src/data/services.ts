...
export const services: Service[] = [
    ...
    },
    {
        ...
        description: 'Admissions marketing for schools, universities, and coaching institutes. Year-round campaigns that fill seats and drive enrollments.',
        icon: '🎓',
        category: 'vertical',
        keywords: ['education marketing agency', 'school admissions marketing', 'university enrollment marketing'],
    },
    {
        title: 'EdTech Marketing',
        slug: 'edtech-marketing',
        description: 'Growth marketing for EdTech platforms and online learning companies. Reduce CAC, improve trial-to-paid, and scale user acquisition.',
        icon: '💻',
        category: 'vertical',
        keywords: ['edtech marketing agency', 'edtech growth marketing', 'edtech user acquisition'],
    },
    {
        title: 'D2C & E-commerce Marketing',
        slug: 'd2c-ecommerce-marketing',
        description: 'Full-funnel performance marketing for D2C and e-commerce brands. AI-powered creative testing, paid acquisition, and lifecycle marketing.',
        icon: '🛒',
        category: 'vertical',
        keywords: ['d2c marketing agency', 'ecommerce marketing agency', 'dtc growth agency'],
    },
    {
        title: 'SaaS Marketing',
        slug: 'saas-marketing',
        description: 'Growth marketing for B2B and B2C SaaS companies. Reduce CAC, build pipeline, and scale revenue through paid, SEO, and funnel optimization.',
        icon: '☁️',
        category: 'vertical',
        keywords: ['saas marketing agency', 'b2b saas marketing', 'saas growth agency'],
    },
    {
