...
const socialLinks = [
    {
        label: 'LinkedIn',
        href: 'https://linkedin.com/company/aurelius-media',
        icon: (
    ...
    {
        label: 'X (Twitter)',
        href: 'https://x.com/aureliusmedia',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        label: 'Instagram',
        href: 'https://instagram.com/aureliusmedia',
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <footer className="bg-brand-darker border-t border-brand-border-subtle">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
                    ...
                    {/* Company Links */}
                    <div>
                        <h4 className="text-sm font-semibold uppercase tracking-wider text-brand-gold mb-4">Company</h4>
                    ...
                    {/* Services Links */}
                    <div>
                        <h4 className="text-sm font-semibold uppercase tracking-wider text-brand-gold mb-4">Services</h4>
                        <ul className="space-y-3">
